    ...
    <div id="forms">
        <% String pdoName=(String)request.getAttribute("pdoName");
            ...
            for(int j = 0; j < recordInfos.size(); j++){
                ...
                out.println("<td><a href=\"GetRecordDetail.action?generateTime="+recordInfos.elementAt(j).elementAt(0)+"\">详情</a></td>\n" +
                            "<td><a href=\"DeleteRecord.action?generateTime="+recordInfos.elementAt(j).elementAt(0)+"\">删除</a></td>\n" +
                            "<td><a href=\"ReadyToUpdateRecord.action?generateTime="+recordInfos.elementAt(j).elementAt(0)+"\">更新</a></td>\n" +
                            "<td><a href=\"Connect.action?generateTime="+recordInfos.elementAt(j).elementAt(0)+"\">建立关联</a></td>");
                out.println("</tr>");
            }
            out.println("</table>");
        %>
