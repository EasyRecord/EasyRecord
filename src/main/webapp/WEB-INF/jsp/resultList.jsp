...
<div class="container">
    ...
    <div class="main-table">
        <table class="table table-hover">
            ...
            <%--<s:iterator value="recordInfos" var="inRecordInfo">--%>
                <%--<tr>--%>
                    <%--<s:iterator value="inRecordInfo">--%>
                        <%--<td><s:property /></td>--%>
                    <%--</s:iterator>--%>
                    <%--<td class="operation-box">--%>
                        <%--<s:url var="detailURL" action="GetRecordDetail">--%>
                            <%--<s:param name="pdoName"><s:property value="pdoName"/></s:param>--%>
                            <%--<s:param name="key"><s:property value='<% out.print(recordInfos.elementAt(i).elementAt(0));%>'/></s:param>--%>
                        <%--</s:url>--%>
                        <%--<s:a href="%{detailURL}" class="operation">详情</s:a>--%>

                        <%--&lt;%&ndash;<a href="GetRecordDetail.action?key="<% out.print(recordInfos.elementAt(i).elementAt(0)); %>"&pdoName="<s:property value="pdoName"/> class="operation">详情 </a>&ndash;%&gt;--%>
                        ...
                        <%--&lt;%&ndash;<a href="ReadyToUpdateRecord.action?key="<% out.print(recordInfos.elementAt(i).elementAt(0)); %> class="operation" data-toggle="tooltip" data-placement="bottom" title="更新"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span> </a>&ndash;%&gt;--%>
                        ...
                        <%--&lt;%&ndash;<a href="Connect.action?key="<% out.print(recordInfos.elementAt(i++).elementAt(0)); %>  class="operation" data-toggle="tooltip" data-placement="bottom" title="建立关联"><span class="glyphicon glyphicon-paperclip" aria-hidden="true"></span></a>&ndash;%&gt;--%>
                    <%--</td>--%>
                <%--</tr>--%>
            <%--</s:iterator>--%>
