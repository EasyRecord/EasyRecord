    ...
    <div class="main-form">
        <form class="form-horizontal" method="post" action="GeneratePdo.action">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="pdoName" placeholder="PDO名">
                </div>
            </div>
